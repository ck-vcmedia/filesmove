...
const agentNotes = [
  {
    name: 'If the caller wants to speak with a Oi2Go Rep.',
    body: ['A Oi2Go investor relations executive will follow up with you once you reserve your shares.', 'All of the information is available via www.Oi2Go.com']
  }
];

class Oi2Go8635 extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      loading: false,
      offerName: 'Oi2Go',
      intakeNumber: '800-298-8635',
      issuerId: '5abd990b9c18aa005e23ab62',
      campaignId: '5abe793cd474c1005ecfa812'
    }
...
export default reduxForm({
  ...
  connect(null, { createLead, createTestLead })(Oi2Go8635)
);