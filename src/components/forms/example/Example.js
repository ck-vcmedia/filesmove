...
const agentNotes = [
  {
    name: 'If the caller wants to speak with a World Investment Properties rep.',
    body: ['A WIP investor relations executive will follow up with you once you reserve your shares.', 'All of the information is available via www.worldinvestmentproperties.com']
  }
];
...
class Example extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      testMode: false,
      loading: false,
      offerName: 'World Investment Properties',
      intakeNumber: '800-800-800',
      issuerId: '5ad621b3020cab005ef87230',
      campaignId: '5ad621d2020cab005ef87231'
    }
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-4">
              ...
              <ul>
                <li>Price Per Share: $6.00</li>
                <li>Min. Investment Amt: $1000</li>
                <li>Funding Goal: $5,000,000</li>
                <li>Filing Type: Regulation D</li>
              </ul>
            </div>
            ...
            <p className="lead">{`Hi, and thank you for calling about the ${this.state.offerName} investment opportunity. A ${this.state.offerName} representative will answer all of your questions. I just have a few questions to ask you first.`}</p>
              <form onSubmit={handleSubmit(this.onFormSubmit.bind(this))}>
                ...
                <Field
                  question="Are you an accredited investor? Is your annual income over $200,000 and/or have a net worth of at least $1,000,000?"
                  component={this.renderSelectField}
...
export default reduxForm({
  ...
  connect(null, { createLead, createTestLead })(Example)
);