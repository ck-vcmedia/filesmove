...
const agentNotes = [
  {
    name: 'If the caller wants to speak with a Elegance Vodka Rep.',
    body: ['A Elegance Vodka investor relations executive will follow up with you once you reserve your shares.', 'All of the information is available via www.EleganceVodka.com']
  }
];

class EleganceVodka6761 extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      testMode: false,
      loading: false,
      offerName: 'Elegance Vodka',
      intakeNumber: '800-298-6983',
      issuerId: '5abda3979c18aa005e23ab64',
      campaignId: '5abe76a5d474c1005ecfa80d'
    }
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-8" ref={(form) => { this.form = form} }>
              ...
              <p className="lead">This call me be recorded for quality assurance.</p>
...
export default reduxForm({
  validate,
  form: 'EleganceVodka6761'
})(
  connect(null, { createLead, createTestLead })(EleganceVodka6761)
);