...
const agentNotes = [
  {
    name: 'If the caller wants to speak with a Hologram USA Rep.',
    body: ['A Hologram USA investor relations executive will follow up with you once you have been verified as an accredited investor or unaccredited for your indications of interest.', 'All of the information is available via www.hologramusa.com']
  }
];

class HologramUSA0831 extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      testMode: false,
      loading: false,
      offerName: 'Hologram USA',
      intakeNumber: '800-225-0381',
      issuerId: '5abd6bf9034be0005c2f13b5',
      campaignId: '5abe786bd474c1005ecfa810'
    }
...
export default reduxForm({
  validate,
  form: 'HologramUSA0831'
})(
  connect(null, { createLead, createTestLead })(HologramUSA0831)
);